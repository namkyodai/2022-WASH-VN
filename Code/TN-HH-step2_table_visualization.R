...
graph_q5 <- ggplot(df2%>%
  ...
  coord_flip()
graph_q5
ggsave("../visuals/TN/graph_q5.png", plot = graph_q5)
...
graph_a2<-df2 %>%
  ...
  labs(
    x="Age")
graph_a2
ggsave("../visuals/TN/graph_a2.png", plot = graph_a2)
...
graph_a3
ggsave("../visuals/TN/graph_a3.png", plot = graph_a3)
...
graph_a3a4
ggsave("../visuals/TN/graph_a3a4.png", plot = graph_a3a4)
...
graph_a4
ggsave("../visuals/TN/graph_a4.png", plot = graph_a4)
...
graph_a4a3
ggsave("../visuals/TN/graph_a4a3.png", plot = graph_a4a3)
...
graph_a4a5
ggsave("../visuals/TN/graph_a4a5.png", plot = graph_a4a5)
...
graph_a3a4a5
ggsave("../visuals/TN/graph_a3a4a5.png", plot = graph_a3a4a5)
...
graph_a5<-ggplot(a5, aes(x = reorder(a5,n),y=n, label=n)) +
  ...
  coord_flip()
graph_a5
ggsave("../visuals/TN/graph_a5.png", plot = graph_a5)
...
graph_a6<-ggplot(a6, aes(x = reorder(a6,n),y=n, label=n)) +
  ...
  coord_flip()
graph_a6
ggsave("../visuals/TN/graph_a6.png", plot = graph_a6)
...
graph_a7_box<-df2 %>%
  ...
  labs(
    x="Family Members")
graph_a7_box
ggsave("../visuals/TN/graph_a7_box.png", plot = graph_a7_box)
...
graph_a7q5<-ggplot(df2, aes(x=q5,y=a7))+
  ...
  coord_flip()
graph_a7q5
ggsave("../visuals/TN/graph_a7q5.png", plot = graph_a7q5)
...
graph_a7a4
ggsave("../visuals/TN/graph_a7a4.png", plot = graph_a7a4)
...
graph_a712
ggsave("../visuals/TN/graph_a712.png", plot = graph_a712)
...
ggsave("../visuals/TN/graph_a8_yes_perc.png", plot = graph_a8_yes_perc)
...
graph_a8_no <- ggplot(data=a8_no, aes(x=value, group=variable, fill=variable)) +
  ...
  theme_ipsum()
graph_a8_no
ggsave("../visuals/TN/graph_a8_no.png", plot = graph_a8_no)
...
ggsave("../visuals/TN/graph_a9.png", plot = graph_a9)
...
#  coord_flip()
graph_a9plus
ggsave("../visuals/TN/graph_a9plus.png", plot = graph_a9plus)
...
graph_a9a9plus
ggsave("../visuals/TN/graph_a9a9plus.png", plot = graph_a9a9plus)
...
#  coord_flip()
graph_a10
ggsave("../visuals/TN/graph_a10.png", plot = graph_a10)
...
graph_a11_1_box<-df2 %>%
  ...
  labs(
    x="Monthly expenses")
graph_a11_1_box
ggsave("../visuals/TN/graph_a11_1_box.png", plot = graph_a11_1_box)
...
graph_a11_1_q5<-ggplot(df2, aes(x=q5,y=a11_1))+
  ...
  coord_flip()
graph_a11_1_q5
ggsave("../visuals/TN/graph_a11_1_q5.png", plot = graph_a11_1_q5)
...
graph_a11_v
ggsave("../visuals/TN/graph_a8_no.png", plot = graph_a11_v)
...
ggsave("../visuals/TN/graph_a11_v_1.png", plot = graph_a11_v_1)
...
graph_a11_v_1_box
ggsave("../visuals/TN/graph_a11_v_1_box.png", plot = graph_a11_v_1_box)
...
ggsave("../visuals/TN/graph_a11_v_234.png", plot = graph_a11_v_234)
...
ggsave("../visuals/TN/graph_a11_v_234_box.png", plot = graph_a11_v_234_box)
...
ggsave("../visuals/TN/graph_a11_v_5.png", plot = graph_a11_v_5)
...
ggsave("../visuals/TN/graph_a11_v_5_box.png", plot = graph_a11_v_5_box)
...
ggsave("../visuals/TN/graph_a11_v_67.png", plot = graph_a11_v_67)
...
ggsave("../visuals/TN/graph_a11_v_67_box.png", plot = graph_a11_v_67_box)
...
ggsave("../visuals/TN/graph_a11_v_8.png", plot = graph_a11_v_8)
...
ggsave("../visuals/TN/graph_a11_v_8_box.png", plot = graph_a11_v_8_box)
...
ggsave("../visuals/TN/graph_a11_v_910.png", plot = graph_a11_v_910)
...
ggsave("../visuals/TN/graph_a11_v_910_box.png", plot = graph_a11_v_910_box)
...
ggsave("../visuals/TN/graph_a11_v_11.png", plot = graph_a11_v_11)
...
ggsave("../visuals/TN/graph_a11_v_11_box.png", plot = graph_a11_v_11_box)
...
ggsave("../visuals/TN/graph_a11_v_12.png", plot = graph_a11_v_12)
...
ggsave("../visuals/TN/graph_a11_v_12_box.png", plot = graph_a11_v_12_box)
...
ggsave("../visuals/TN/graph_a11_v_13.png", plot = graph_a11_v_13)
...
ggsave("../visuals/TN/graph_a11_v_13_box.png", plot = graph_a11_v_13_box)
...
ggsave("../visuals/TN/graph_a11_v_14.png", plot = graph_a11_v_14)
...
ggsave("../visuals/TN/graph_a11_v_14_box.png", plot = graph_a11_v_14_box)
...
ggsave("../visuals/TN/graph_a11_v_1516_box.png", plot = graph_a11_v_1516_box)
...
ggsave("../visuals/TN/graph_a12.png", plot = graph_a12)
...
graph_a13_1_1
ggsave("../visuals/TN/graph_a13_1_1.png", plot = graph_a13_1_1)
...
graph_a13_1_2
ggsave("../visuals/TN/graph_a13_1_2.png", plot = graph_a13_1_2)
...
ggsave("../visuals/TN/graph_a13_2_1.png", plot = graph_a13_2_1)
...
graph_b1_a<-ggplot(b1_a, aes(x = reorder(variable,n),y=n, label=n)) +
  ...
  coord_flip()
graph_b1_a
ggsave("../visuals/TN/graph_b1_a.png", plot = graph_b1_a)
...
graph_b1_b
ggsave("../visuals/TN/graph_b1_b.png", plot = graph_b1_b)
...
graph_b1_4
ggsave("../visuals/TN/graph_b1_4.png", plot = graph_b1_4)
...
graph_b1_2
ggsave("../visuals/TN/graph_b1_2.png", plot = graph_b1_2)
...
graph_b1_5
ggsave("../visuals/TN/graph_b1_5.png", plot = graph_b1_5)
...
graph_b2_1
ggsave("../visuals/TN/graph_b2_1.png", plot = graph_b2_1)
...
graph_b2_2<-ggplot(b2_2, aes(x = reorder(variable,-n),y=n, label=n, fill = q5)) +
  geom_bar(stat="identity", position=position_dodge())+
  geom_text(aes(label = paste0(n)),colour = "black",position = position_dodge(0.9),vjust = 0.51, hjust =0.2) +
  #  geom_text(aes(label = paste0(perc, " %")), position = position_dodge(0.9),vjust = -0.2)+
  theme(legend.position = "right")+
  scale_fill_discrete(name = "Town")+
  labs(
...
graph_b2_2
ggsave("../visuals/TN/graph_b2_2.png", plot = graph_b2_2)
...
#  coord_flip()
graph_b2_4a
ggsave("../visuals/TN/graph_b2_4a.png", plot = graph_b2_4a)
...
graph_b2_4b
ggsave("../visuals/TN/graph_b2_4b.png", plot = graph_b2_4b)
...
graph_b2_4c<-ggplot(b2_4c, aes(x = reorder(q5,n),y=n, label=n)) +
  ...
  coord_flip()
graph_b2_4c
ggsave("../visuals/TN/graph_b2_4c.png", plot = graph_b2_4c)
...
#  coord_flip()
graph_b2_5a
ggsave("../visuals/TN/graph_b2_5a.png", plot = graph_b2_5a)
...
graph_b2_5b
ggsave("../visuals/TN/graph_b2_5b.png", plot = graph_b2_5b)
...
graph_b2_5c<-ggplot(b2_5c, aes(x = reorder(q5,n),y=n, label=n)) +
  ...
  coord_flip()
graph_b2_5c
ggsave("../visuals/TN/graph_b2_5c.png", plot = graph_b2_5c)
...
graph_b3_box
ggsave("../visuals/TN/graph_b3_box.png", plot = graph_b3_box)
...
graph_b3_den<-df2 %>%
  ...
  labs(
    x="Monthly consumption (m3")
graph_b3_den
ggsave("../visuals/TN/graph_b3_den.png", plot = graph_b3_den)
...
graph_b3_q5<-ggplot(df2, aes(x=q5,y=b3))+
  ...
  coord_flip()
graph_b3_q5
ggsave("../visuals/TN/graph_b3_q5.png", plot = graph_b3_q5)
...
ggsave("../visuals/TN/graph_b4.png", plot = graph_b4)
...
ggsave("../visuals/TN/graph_b6.png", plot = graph_b6)
...
graph_b6_1_box
ggsave("../visuals/TN/graph_b6_1_box.png", plot = graph_b6_1_box)
...
#  coord_flip()
graph_b6_1
ggsave("../visuals/TN/graph_b6_1.png", plot = graph_b6_1)
...
#  coord_flip()
graph_b8
ggsave("../visuals/TN/graph_b8.png", plot = graph_b8)
...
graph_b8_ex<-ggplot(b8_ex, aes(x = reorder(b8_ex,n),y=n, label=n)) +
  ...
  coord_flip()
graph_b8_ex
ggsave("../visuals/TN/graph_b8_ex.png", plot = graph_b8_ex)
...
graph_b9<-ggplot(b9, aes(x = reorder(b9,n),y=n, label=n)) +
  ...
  coord_flip()
graph_b9
ggsave("../visuals/TN/graph_b9.png", plot = graph_b9)
...
graph_b10a<-ggplot(b10a, aes(x = reorder(variable,n),y=n, label=n, fill = q5)) +
  ...
  coord_flip()
graph_b10a
ggsave("../visuals/TN/graph_b10a.png", plot = graph_b10a)
...
graph_b10b
ggsave("../visuals/TN/graph_b10b.png", plot = graph_b10b)
...
graph_b11_1
ggsave("../visuals/TN/graph_b11_1.png", plot = graph_b11_1)
...
graph_b12_1
ggsave("../visuals/TN/graph_b12_1.png", plot = graph_b12_1)
...
graph_b13a<-ggplot(b13a, aes(x = reorder(variable,n),y=n, label=n, fill = q5)) +
  ...
  coord_flip()
graph_b13a
ggsave("../visuals/TN/graph_b13a.png", plot = graph_b13a)
...
graph_b13b
ggsave("../visuals/TN/graph_b13b.png", plot = graph_b13b)
...
ggsave("../visuals/TN/graph_c1.png", plot = graph_c1)
...
graph_c2<-ggplot(c2, aes(x = reorder(c2,n),y=n, label=n)) +
  ...
  coord_flip()
graph_c2
ggsave("../visuals/TN/graph_c2.png", plot = graph_c2)
...
ggsave("../visuals/TN/graph_d1.png", plot = graph_d1)
...
graph_d3<-ggplot(d3, aes(x = reorder(d3,n),y=n, label=n)) +
  ...
  coord_flip()
graph_d3
ggsave("../visuals/TN/graph_d3.png", plot = graph_d3)
...
graph_d4<-ggplot(d4, aes(x = reorder(d4,n),y=n, label=n)) +
  ...
  coord_flip()
graph_d4
ggsave("../visuals/TN/graph_d4.png", plot = graph_d4)
...
ggsave("../visuals/TN/graph_d5.png", plot = graph_d5)
...
ggsave("../visuals/TN/graph_d6.png", plot = graph_d6)
...
ggsave("../visuals/TN/graph_d7.png", plot = graph_d7)
...
graph_e1a<-ggplot(e1a, aes(x = reorder(variable,n),y=n, label=n, fill = q5)) +
  ...
  coord_flip()
graph_e1a
ggsave("../visuals/TN/graph_e1a.png", plot = graph_e1a)
...
graph_e1b
ggsave("../visuals/TN/graph_e1b.png", plot = graph_e1b)
...
ggsave("../visuals/TN/graph_e2.png", plot = graph_e2)
...
graph_e3_1
ggsave("../visuals/TN/graph_e3_1.png", plot = graph_e3_1)
...
graph_e3_2_box
ggsave("../visuals/TN/graph_e3_2_box.png", plot = graph_e3_2_box)

# density
graph_e3_2_den<-df2 %>%
  ggplot(aes(as.numeric(e3_2)))+
  geom_density()  +  
  labs(
    x="Payment for solid waste disposal (VND)")
graph_e3_2_den
ggsave("../visuals/TN/graph_e3_2_den.png", plot = graph_e3_2_den)
...
ggsave("../visuals/TN/graph_e3_2.png", plot = graph_e3_2)
...
ggsave("../visuals/TN/graph_e4.png", plot = graph_e4)
...
ggsave("../visuals/TN/graph_e5.png", plot = graph_e5)
...
graph_e5_box<-df2 %>%
  ...
  labs(
    x="Payment for solid waste disposal (VND)")
graph_e5_box
ggsave("../visuals/TN/graph_e5_box.png", plot = graph_e5_box)
...
ggsave("../visuals/TN/graph_e6.png", plot = graph_e6)
...
ggsave("../visuals/TN/graph_e7.png", plot = graph_e7)
...
graph_e8a<-ggplot(e8a, aes(x = reorder(variable,n),y=n, label=n, fill = q5)) +
  ...
  coord_flip()
graph_e8a
ggsave("../visuals/TN/graph_e8a.png", plot = graph_e8a)
...
graph_e8b
ggsave("../visuals/TN/graph_e8b.png", plot = graph_e8b)
...
ggsave("../visuals/TN/graph_f3.png", plot = graph_f3)
...
graph_f4a<-ggplot(f4a, aes(x = reorder(variable,n),y=n, label=n, fill = q5)) +
  ...
  coord_flip()
graph_f4a
ggsave("../visuals/TN/graph_f4a.png", plot = graph_f4a)
...
graph_f4b
ggsave("../visuals/TN/graph_f4b.png", plot = graph_f4b)
...
f5<-df2%>%
  select(q5,f5.2,f5.3,f5.4,f5.5,f5.6,f5.7,f5.8,f5.9,f5.10)
f5 <- melt(f5,id=c("q5"),na.rm = TRUE)



f5$variable<-recode(f5$variable,f5.2="Health protection",f5.3="Convenient",f5.4="Quality of water can be guaranteed without harmful contaminants",f5.5="Clean environment",f5.6="Reduce cost for water use",f5.7="Better living conditions",f5.8="Sufficient amount of water can be delivered continuously",f5.9="Have a business/service opportunity",f5.10="No water borne disease")
f5
...
graph_f5a<-ggplot(f5a, aes(x = reorder(variable,n),y=n, label=n, fill = q5)) +
  ...
  coord_flip()
graph_f5a
ggsave("../visuals/TN/graph_f5a.png", plot = graph_f5a)
...
graph_f5b
ggsave("../visuals/TN/graph_f5b.png", plot = graph_f5b)
...
graph_f1a<-ggplot(f1a, aes(x = reorder(variable,n),y=n, label=n, fill = q5)) +
  ...
  coord_flip()
graph_f1a
ggsave("../visuals/TN/graph_f1a.png", plot = graph_f1a)
...
graph_f1b
ggsave("../visuals/TN/graph_f1b.png", plot = graph_f1b)
...
f2<-df2%>%
  select(q5,f2.1,f2.2,f2.3,f2.5,f2.6,f2.8,f2.9,f2.10,f2.11,f2.12,f2.13,f2.14)
...
graph_f2a<-ggplot(f2a, aes(x = reorder(variable,n),y=n, label=n, fill = q5)) +
  ...
  coord_flip()
graph_f2a
ggsave("../visuals/TN/graph_f2a.png", plot = graph_f2a)
...
graph_f2b
ggsave("../visuals/TN/graph_f2b.png", plot = graph_f2b)
...
graph_g1
ggsave("../visuals/TN/graph_g1.png", plot = graph_g1)
...
graph_g1b
ggsave("../visuals/TN/graph_g1b.png", plot = graph_g1b)
...
ggsave("../visuals/TN/graph_g2.png", plot = graph_g2)
...
graph_g2a
ggsave("../visuals/TN/graph_g2a.png", plot = graph_g2a)
...
ggsave("../visuals/TN/graph_g4.png", plot = graph_g4)
...
graph_g4a
ggsave("../visuals/TN/graph_g4a.png", plot = graph_g4a)
...
ggsave("../visuals/TN/graph_g5_1.png", plot = graph_g5_1)
...
graph_g5_1a
ggsave("../visuals/TN/graph_g5_1a.png", plot = graph_g5_1a)
...
ggsave("../visuals/TN/graph_g5_1_ex.png", plot = graph_g5_1_ex)
...
ggsave("../visuals/TN/graph_g5_1_exa.png", plot = graph_g5_1_exa)
...
ggsave("../visuals/TN/graph_g5_2.png", plot = graph_g5_2)
...
graph_g5_2a
ggsave("../visuals/TN/graph_g5_2a.png", plot = graph_g5_2a)
...
ggsave("../visuals/TN/graph_g5_2_ex.png", plot = graph_g5_2_ex)
...
ggsave("../visuals/TN/graph_g5_2_exa.png", plot = graph_g5_2_exa)
...
graph_g5_2_ex_box
ggsave("../visuals/TN/graph_g5_2_ex_box.png", plot = graph_g5_2_ex_box)
...
graph_g5_2_ex_den<-df2 %>%
  ...
  labs(
    x="Thousand VND/month")
graph_g5_2_ex_den
ggsave("../visuals/TN/graph_g5_2_ex_den.png", plot = graph_g5_2_ex_den)
...
ggsave("../visuals/TN/graph_g6.png", plot = graph_g6)
...
graph_g6a
ggsave("../visuals/TN/graph_g6a.png", plot = graph_g6a)
...
ggsave("../visuals/TN/graph_g7_1.png", plot = graph_g7_1)
...
graph_g7_1a
ggsave("../visuals/TN/graph_g7_1a.png", plot = graph_g7_1a)
...
graph_g7_2_box<-df2 %>%
  ...
  labs(
    x=" million VND")
graph_g7_2_box
ggsave("../visuals/TN/graph_g7_2_box.png", plot = graph_g7_2_box)
...
graph_g7_2_den<-df2 %>%
  ...
  labs(
    x="million VND")
graph_g7_2_den
ggsave("../visuals/TN/graph_g7_2_den.png", plot = graph_g7_2_den)
...
ggsave("../visuals/TN/graph_g8.png", plot = graph_g8)
